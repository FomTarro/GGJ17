...
Shader "We Need Bees/Bees Water Collision" {
    Properties {
        ...
        _SplashArea ("Splash Area", Float ) = 2
        _SplashStrength ("Splash Strength", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_1017 = 0.0;
                float node_1962 = (_SplashArea+(-1*sqrt(distance(mul(unity_ObjectToWorld, v.vertex).rgb,_Impact1.rgb))));
                float node_7948 = clamp(_Impact1.a,0,1);
                float node_8476 = lerp(node_1017,clamp(node_1962,0,1000),node_7948);
                float node_7164 = sin(node_8476);
                v.vertex.xyz += (((saturate((float3(0,1,0)*node_7145.rgb))*1.0+-0.5)*_WaveSize)+float3(node_1017,(node_1017 + ( (node_7164 - node_1017) * (_SplashStrength - node_1017) ) / (_SplashArea - node_1017)),node_1017));
